...
import SoalEmwaKPU from "@/data/SoalEmwaKpu";
...
const SoalEMWA = () => {
  ...
  const handleKumpulkan = () => {
    ...
    setIsDone(true); // Setelah mengumpulkan, tandai bahwa soal telah selesai.
  };
      ...
      <div className="container mx-auto my-12 flex justify-between flex-row-reverse flex-wrap">
        ...
        <div className="w-full md:w-2/3 px-4 md:px-4 mt-8 md:mt-0">
          ...
          <div className="flex gap-x-8 items-center justify-end">
            ...
            {isLastSoal ? (
              <button onClick={handleKumpulkan} className="shadow-button !py-2">
                Kumpulkan
              </button>
            ) : (
              <button
...
SoalEMWA.getLayout = (page: any) => {
  return <BlankLayout>{page}</BlankLayout>;
};

export default SoalEMWA;
