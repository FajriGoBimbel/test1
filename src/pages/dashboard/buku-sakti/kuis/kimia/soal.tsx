      ...
      <div className="container mx-auto my-12 flex justify-between flex-row-reverse flex-wrap">
        ...
        <div className="w-full md:w-2/3 px-4 md:px-4 mt-8 md:mt-0">
          <div className="flex gap-x-2 items-center mb-6">
            ...
            <div>
              <h5 className="mb-1">KUIS-098764</h5>
              <h1 className="font-semibold text-base">KIMIA</h1>
            </div>
          </div>
          {/* Modal */}
          <Dialog
          ...
          >
            ...
            >
              ...
              <h1 className="uppercase text-center text-2xl font-semibold mb-4">
                kuis-098764 <br /> fisika
              </h1>
              <p>
                Jika keluar tanpa mengumpulkan kuis, maka soal belum dijawab
                akan dianggap kosong oleh sistem. Tombol `Kumpulkan` hanya aktif
                di nomor terakhir Kuis.
                <div className="mt-4" />
                Apakah kamu yakin ingin keluar tanpa menyelesaikan kuis?
              </p>
              {/* END:Content */}
          ...
          <div className="flex gap-x-8 items-center justify-end">
            ...
            >
              ...
              >
                ...
                <p>
                  Setelah mengumpulkan kuis ini, kamu tidak akan bisa kembali
                  mengerjakan soal lagi. Yakin mau mengumpulkan dan lihat hasil
                  sekarang?
                </p>
                {/* END:Content */}
                <div className="flex justify-end gap-x-4 items-center mt-6">
