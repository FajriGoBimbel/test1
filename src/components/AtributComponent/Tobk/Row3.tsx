...
const Row3Tobk = () => {
  ...
  return (
    <div className="flex flex-wrap items-end mt-16 sm:mt-28">
      {/* column 1 */}
      ...
      <ModalTobk
        open={open}
        onClick={handleToggle}
        detailTitle="detail tobk intensif 2"
        syaratTitle="syarat tobk intensif 2"
        detailTobk={DetailTOBKIntensif2}
      ...
      <ModalTobk
        open={open2}
        onClick={handleToggle2}
        detailTitle="detail tobk intensif 3"
        syaratTitle="syarat tobk intensif 3"
        detailTobk={DetailTOBKIntensif3}
        syaratTobk={SyaratTOBK}
      />
    </div>
  );
