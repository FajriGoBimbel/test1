...
const DetailTOBKSuperIntensif1 = [
  {
    kelas: "12 SMA",
...
const DetailTOBKSuperIntensif2 = [
  {
    kelas: "12 SMA",
    kode: "UAT - TOBK - 12 SMA - S1 - KMER",
    tanggal: "Sabtu, 10 November 2023",
...
const Row4Tobk = () => {
  ...
  return (
    <div>
      <div className="flex flex-wrap flex-row-reverse items-end mt-16 sm:mt-28">
        {/* column 1 */}
        ...
        <ModalTobk
          open={open}
          onClick={handleToggle}
          detailTitle="detail tobk super intensif 1"
          syaratTitle="syarat tobk super intensif 1"
          detailTobk={DetailTOBKSuperIntensif1}
        ...
        <ModalTobk
          open={open2}
          onClick={handleToggle2}
          detailTitle="detail tobk super intensif 2"
          syaratTitle="syarat tobk super intensif 2"
          detailTobk={DetailTOBKSuperIntensif2}
          syaratTobk={SyaratTOBK}
        />
      </div>
    </div>
